...
class DateTimeSpec extends ObjectBehavior
{
    ...
    {
        $this->fake('timestamp')->shouldBeInt();
        $this->fake('unixTime')->shouldBeInt();
    }
}
