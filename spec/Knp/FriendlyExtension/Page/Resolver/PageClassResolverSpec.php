...
namespace spec\Knp\FriendlyExtension\Page\Resolver;
...
class PageClassResolverSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Knp\FriendlyExtension\Page\Resolver\PageClassResolver');
    }
    ...
    {
        $this->shouldThrow('InvalidArgumentException')->duringCreate($session, 'Knp\FriendlyExtension\Page\Resolver\PageClassResolver');
    }
    ...
    {
        $this
            ->create($session, 'Knp\FriendlyExtension\Page\Page')
            ->shouldHaveType('Knp\FriendlyExtension\Page\Page')
        ;
    }
